<template>
    <div class="container mx-auto px-5">
        <JobFilter />
        <SearchVacansies v-model:searchValue="searchValue" @search-resumes="searchVacancies" :is-filter-btn="true"
            class="mt-10" />
        <section class="min-h-52">
            ...
            <div v-if="vacancies.length" class="grid grid-cols-2 mt-10 gap-6">
                <VacancyCard v-for="vacancy in vacancies" :key="'vacancy-id' + vacancy.id" :vacancy="vacancy" />
            </div>
