      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10" v-else>
        <div>
          ...
          <div v-for="cat in category" :key="'cat-id' + cat.id" class="mb-1">
            <Checkbox class="mr-2" :inputId="'cat-' + cat.id" :value="cat.id" v-model="filter.categories" />
        ...
        <div>
          ...
          <div v-for="comp in compensation" :key="'comp-id' + comp.id" class="mb-1">
            <Checkbox class="mr-2" :inputId="'comp-' + comp.id" :value="comp.id" v-model="filter.compensations" />
        ...
        <div>
          ...
          <div v-for="lvl in level" :key="'lvl-id' + lvl.id" class="mb-1">
            <Checkbox class="mr-2" :inputId="'lvl-' + lvl.id" :value="lvl.id" v-model="filter.levels" />
        ...
        <div>
          ...
          <div v-for="loc in location" :key="'loc-id' + loc.id" class="mb-1">
            <Checkbox class="mr-2" :inputId="'loc-' + loc.id" :value="loc.id" v-model="filter.locations" />
...
const { fetchCategories, filter, category, location, compensation, level, isOptionsLoading, clearFilters } =
  useFilterOPtions()
